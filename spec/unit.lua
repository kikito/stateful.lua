...
describe("Unit tests", function()
  ...
  describe('getCurrentStateName', function()
    test("returns nil when there is no state", function()
      e = Enemy:new()
      assert_nil(e:getCurrentStateName())
    end)
    test("returns the name of the current state", function()
      ...
      e = Enemy:new()
      e:gotoState('State1')
      assert_equal(e:getCurrentStateName(), 'State1')
      e:pushState('State2')
      assert_equal(e:getCurrentStateName(), 'State2')
    end)
  end)
